...
<?php
    ...
    if(isset($_GET['del'])){
		$id = $_GET['del'];
		mysqli_query($db,"DELETE FROM noticedetail Where id =$id");
...
{    
 ...
 if(move_uploaded_file($file_loc,$folder.$final_file))
 {
  ...
  alert('successfully uploaded');
        window.location.href='allnotice.php?success';
 ...
 ?>
	...
	<script type="text/javascript">$(document).ready(function(){
        ...
        <table border="1" cellpadding="0" class="table table-bordered table-hover" cellspacing="0" id="myTable" class="display" width="100%">
				...
				<?php
				$db = mysqli_connect("localhost","root","","project");
				$sql="SELECT id,file,date FROM noticedetail";
		        ...
		        <td><a class="btn btn-danger" href="allnotice.php?del=<?php echo $row['id'];?>">DELETE</a></td>
